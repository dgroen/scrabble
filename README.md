# Scrabble - Online Scrabble Game with Multi-Language Support
Een online Scrabble spel waar meerdere spelers samen kunnen spelen met officiële Scrabble regels en ondersteuning voor meerdere talen.

An online Scrabble game where multiple players can play together following official Scrabble rules with multi-language support.

## Features / Kenmerken

### Implemented Official Scrabble Rules / Geïmplementeerde Officiële Scrabble Regels

- ✅ **Multi-language support** - English, Dutch (Nederlands), and Finnish (Suomi)
- ✅ **Language-specific letter distributions** - Authentic letter frequencies for each language
- ✅ **Localized interface** - All game text displayed in selected language
