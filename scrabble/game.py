...
class Game:
    ...
    def place_word(self, word_placement: List[Tuple[int, int, Tile]]) -> Tuple[bool, str, int]:
    ...
    def _validate_placement(self, word_placement: List[Tuple[int, int, Tile]]) -> Tuple[bool, str]:
    ...
    def _get_all_formed_words(self, word_placement: List[Tuple[int, int, Tile]]) -> List[Tuple[str, List[Tuple[int, int]]]]:
    ...
    def _calculate_score(self, word_placement: List[Tuple[int, int, Tile]], 
